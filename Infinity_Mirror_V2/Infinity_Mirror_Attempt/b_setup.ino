void setup() {
  ...
  FastLED.setMaxPowerInVoltsAndMilliamps(5,240); //sets max power to ensure safe usage //parameters are (5,3000)
  ...
  attachInterrupt(digitalPinToInterrupt(IR_RECEIVE_PIN), IRTranslate, RISING);
